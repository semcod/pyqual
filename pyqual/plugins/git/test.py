...
class TestSecretScanning:
    ...
    def temp_repo_with_secrets(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            (repo_path / "safe.py").write_text('API_KEY = "your_key_here"\n')
    ...
    def test_scan_finds_github_token(self, temp_repo_with_secrets):
        ...
        github_secrets = [
            s for s in result["secrets_found"] if "github" in s["type"].lower()
        ]
    ...
    def test_scan_finds_aws_key(self, temp_repo_with_secrets):
        ...
        aws_secrets = [s for s in result["secrets_found"] if "aws" in s["type"].lower()]
...
class TestSecretPatterns:
    ...
    def test_jwt_token_pattern(self):
        ...
        assert pattern.search(
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIn0.dozjgNryP4J3jVmNHl0w5N_XgL0n3I9PlFUP0THg"
        )
