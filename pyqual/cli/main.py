...
def tune_thresholds_cmd(
    ...
    try:
        ...
        console.print(
            f"[yellow]⚠️  Config not found: {config_path}. Run 'pyqual init'.[/yellow]"
        )
        raise typer.Exit(1)
...
# Sub-apps
git_app = typer.Typer(
    help="Git repository operations: status, commit, push with protection handling."
)
app.add_typer(git_app, name="git")

tickets_app = typer.Typer(
    help="Control planfile-backed tickets from TODO.md and GitHub."
)
