...
- **Calls**: app.command, typer.Option, typer.Option, typer.Option, typer.Option, typer.Option, pyqual.cli._setup_logging, PyqualConfig.load
...
- `pyqual.bulk_init.collect_fingerprint` - 13 calls
